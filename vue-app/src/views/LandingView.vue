...
<template>
  <div class="min-h-[calc(100vh-64px)] flex items-center justify-center bg-zinc-50 p-4">
    <!-- Main Card -->
    <div class="w-full max-w-4xl bg-white rounded-lg border border-zinc-200 overflow-hidden flex shadow-xl shadow-zinc-200/50 md:min-h-[500px]">
